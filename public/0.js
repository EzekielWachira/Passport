...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    _api_user__WEBPACK_IMPORTED_MODULE_0__["default"].auth().then(function (response) {
    ...
    [
      _vm.user
        ? _c(
            ...
            [
              _c("q-card-section", { staticClass: "text-h5 text-orange" }, [
                _vm._v("Welcome")
              ]),
              _vm._v(" "),
              _c("q-card-section", { staticClass: "text-h6 text-positive" }, [
